#!/bin/bash
#shadowsocks-libev obfs install by Paidi
...
cd /usr/bin
wget -O addss "https://raw.githubusercontent.com/MMemekbau144/yahaha/main/addss.sh"
wget -O delss "https://raw.githubusercontent.com/MMemekbau144/yahaha/main/delss.sh"
wget -O cekss "https://raw.githubusercontent.com/MMemekbau144/yahaha/main/cekss.sh"
wget -O xp-ss "https://raw.githubusercontent.com/MMemekbau144/yahaha/main/xp-ss.sh"
wget -O renewss "https://raw.githubusercontent.com/MMemekbau144/yahaha/main/renewss.sh"
chmod +x addss
chmod +x delss
chmod +x cekss
chmod +x xp-ss
